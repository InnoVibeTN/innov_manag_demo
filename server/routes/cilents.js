...
route.get('/getAll', auth, (req, res) => {
  ...
  var query = connection.query(
    'SELECT c.nom , c.tel_client , c.statue , sum( v.prix_tot - ((v.prix_tot/100) * v.remise) ) as total , sum(v.prix_donnee) as donnee FROM clients as c , ventes as v where statue = 1 and c.id_client = v.id_client GROUP BY c.id_client',
